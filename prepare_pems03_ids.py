...
# -*- coding: utf-8 -*-
"""
Prepare PEMS03 ID mapping file
Extracts unique sensor IDs from PEMS03.csv and creates 0-indexed mapping
"""

import csv
import numpy as np

# Read PEMS03.csv and extract unique sensor IDs
csv_file = 'data/PEMS03/PEMS03.csv'
unique_ids = set()
...
# Expected number of sensors for PEMS03
expected_sensors = 358
...
id_file = 'data/PEMS03/PEMS03_node_ids.txt'
...
np.save('data/PEMS03/PEMS03_adj.npy', A)
np.save('data/PEMS03/PEMS03_distance.npy', distance_A)

print(f"\nAdjacency matrices saved:")
print(f"  - data/PEMS03/PEMS03_adj.npy")
print(f"  - data/PEMS03/PEMS03_distance.npy")
print(f"\nAdjacency matrix shape: {A.shape}")
print(f"Number of edges: {int(A.sum())}")

print("\n" + "="*60)
print("DONE! Now update PEMS03_astgcn.conf to use:")
